...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View frag1view = inflater.inflate(R.layout.frag1, container, false);
        mChronometer = (Chronometer) frag1view.findViewById(R.id.chronometer);
        mTextureView = (TextureView) frag1view.findViewById(R.id.textureView);
        mStillImageButton = (ImageButton) frag1view.findViewById(R.id.cameraImageButton2);
